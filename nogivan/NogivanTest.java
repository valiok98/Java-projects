...
public class NogivanTest {
  ...
  public void testabcd1() throws SAXException, IOException, ParserConfigurationException {
    ...
    //System.out.println("length and check : " + pathLength);
    System.out.println("length and check : " + rr.getDistance());
    assertTrue(pathLength == rr.getDistance());
    GPXWriter test_writer = new GPXWriter("src\\nogivan\\testabcd1.gpx");
    test_writer.write(rr);
