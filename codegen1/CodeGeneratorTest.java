...
public class CodeGeneratorTest {
  ...
  private static Program test() {
	    Function mainFunctionFak = new Function("main", new String[] {}, new Declaration[] {new Declaration(new String[] {"n"})},
	        new Statement[] {new Return(new Call("func2",new Expression[] {new Variable("n")} ))});
	    Function func_2 = new Function("func2", new String[] {"n"} , new Declaration[] {}, new Statement[] {new Assignment("n", new Number(3)) ,
	    		new Return(new Variable("n"))} );
	    Program fakProgram = new Program(new Function[] {mainFunctionFak,func_2});
	    return fakProgram;
	  }
